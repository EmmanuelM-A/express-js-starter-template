 ...
 * @param {string} errorCode The error code to include in the response.
 ...
 * @returns {void}
 */
export const sendErrorResponse = (response, statusCode, message, errorCode, details = null, stackTrace = null) => {
    const errorResponse = new ApiErrorResponse(message, errorCode, details, stackTrace);
